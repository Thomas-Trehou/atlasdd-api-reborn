...
@Component("customCharacterSecurityService")
public class CustomCharacterSecurityService {

    private final CustomCharacterSheetRepo characterSheetRepo;
    private final UserRepo userRepository;

    public CustomCharacterSecurityService(CustomCharacterSheetRepo characterSheetRepo, UserRepo userRepository) {
