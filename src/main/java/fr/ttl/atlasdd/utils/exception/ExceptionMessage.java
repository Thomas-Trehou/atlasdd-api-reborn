...
public enum ExceptionMessage {
    ...
    ARMOR_RETRIEVE_ERROR("Erreur lors de la récupération des armures"),
    ...
    BACKGROUND_RETRIEVE_ERROR("Erreur lors de la récupération des backgrounds"),
    ...
    CLASS_RETRIEVE_ERROR("Erreur lors de la récupération des classes"),
    ...
    RACE_RETRIEVE_ERROR("Erreur lors de la récupération des races"),
