...
private final List<CustomCharacterSheetApiDto> CUSTOM_CHARACTER_SHEET_API_DTO_LIST = Collections.emptyList();
    ...
    private final CustomCharacterSheetCreateRequestApiDto CUSTOM_CHARACTER_SHEET_CREATE_REQUEST_API_DTO = new CustomCharacterSheetCreateRequestApiDto(
            ...
            SHIELD_TYPE, TWO_WEAPONS, ALIGNMENT_TYPE, STRENGTH, DEXTERITY, CONSTITUTION, INTELLIGENCE, WISDOM, CHARISMA, STRENGTH_ST, DEXTERITY_ST, CONSTITUTION_ST, INTELLIGENCE_ST, WISDOM_ST, CHARISMA_ST,STATUS_TYPE,SPELLSLOTS, USER_ID, RACE, BACKGROUND, CLASS, SKILLS, SPELLS, WEAPONS, ARMOR);
    ...
    private final CustomCharacterSheetApiDto CUSTOM_CHARACTER_SHEET_API_DTO = new CustomCharacterSheetApiDto(
            NAME, LEVEL, EXPERIENCE_POINTS, ARMOR_CLASS, INITIATIVE, INSPIRATION, HIT_POINTS, MAX_HIT_POINTS, BONUS_HIT_POINTS, SPEED, PASSIVE_PERCEPTION,
            SHIELD_TYPE, TWO_WEAPONS, ALIGNMENT_TYPE, STRENGTH, DEXTERITY, CONSTITUTION, INTELLIGENCE, WISDOM, CHARISMA, SPELLSLOTS, STRENGTH_ST, DEXTERITY_ST, CONSTITUTION_ST, INTELLIGENCE_ST, WISDOM_ST, CHARISMA_ST, STATUS_TYPE, USER, RACE, BACKGROUND, CLASS, SKILLS_API_DTO, SPELLS_API_DTO, WEAPONS, ARMOR);
